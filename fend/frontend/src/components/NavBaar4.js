        ...
        <div className='shadow-md w-full fixed top-0 left-0'  >
            <div className='md:flex items-center justify-between bg-white py-4 md:px-10 px-7'  style={{  height:'80px' }}>
                ...
                <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static bg-white md:z-auto z-[-1] left-0 w-full md:w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-12' : 'top-[-490px]'}`}>
                    ...
                    <button  className='btn bg-black text-white md:ml-8 font-semibold px-3 py-1 rounded duration-500 md:static' onClick={() => { window.location.href = '/' }}>Add Parent</button>
